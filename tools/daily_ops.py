...
def reconcile_sap_vs_es_sales(start_date: str, end_date: str) -> dict:
    try:
        """
         MongoDB ES collection name: es
         Sample ES Document:
        {
            "_id": {
                "$oid": "68517db97d5c235e79375350"
            },
            "Processing center ": "US",
            "legal company code": "US10",
            "Sold to country": "US",
            "Payment country ": "US",
            "Distributor country ": "US",
            "Buyer country": "US",
            "Slip": {
                "$numberLong": "2998786751434"
            },
            "Distribtutor id": "V2998004",
            "Buyer id": {
                "$numberLong": "47000044000"
            },
            "Amount": 210,
            "Currency ": "USD",
            "GWS order number": {
                "$numberLong": "8001103610"
            },
            "Sale date": {
                "$date": "2025-05-28T18:30:00.000Z"
            },
            "Invoice date": "2025/05/29",
            "Invoice document number": 1900900032,
            "Invoice year ": 2025,
            "Distributor name": "JOY D MALANAG",
            "Buyer name": "GOC]ADAZE FOLTZ #3",
            "Distributor rank": "4A"
            }

            MongoDB SAP collection name: sap
            Sample SAP Document:            
         {
            "_id": {
                "$oid": "68517ddd7d5c235e7937592a"
            },
            "Processing center ": "US",
            "legal company code": "US10",
            "Sold to country": "US",
            ...
            "Buyer country": "US",
            "Slip": {
                "$numberLong": "2998786751431"
            },
            "Distribtutor id": "V2998001",
            "Buyer id": {
                "$numberLong": "44000022843"
            },
            "Amount": 110,
            "Currency ": "USD",
            "GWS order number": {
                "$numberLong": "8001103176"
            },
            "Payment date": "9 Jun 25",
            "Sale date": {
                "$date": "2025-05-28T18:30:00.000Z"
            },
            "Invoice date": "29 May 25",
            "Invoice document number": 1900900011,
            "Invoice year ": 2025,
            "Payment document number": 2000226942,
            "Payment  year ": 2025,
            "Payment method": "C",
            "Check number": 2201,
            "Distributor name": "Gyan K Dangol",
            "Buyer name": "GOC]***##MOHAMMED SHAKHAWAT HOSSAIN #2",
            "Distributor rank": "1A"
            }
